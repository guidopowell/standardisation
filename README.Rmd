...
knitr::include_graphics("vignettes/plot_agregation.PNG")
```
...
```{r, fig.align="center", out.width = "70%",fig.border = "none", echo=FALSE}
knitr::include_graphics("vignettes/plot_indirect.PNG")
```
...
```
```{r, fig.align="center",out.width = "70%", fig.border = "none", echo=FALSE}
knitr::include_graphics("vignettes/plot_externe.PNG")
```
