...
knitr::include_graphics("vignettes/image_num_filtre.PNG")
```
...
```{r, out.width = "20%", fig.align="center", fig.border = "none", echo=FALSE}
knitr::include_graphics("vignettes/image_num_total.PNG")
```
...
```{r, out.width = "20%", fig.align="center", fig.border = "none", echo=FALSE}
knitr::include_graphics("vignettes/image_num_col.PNG")
```
...
```{r, out.width = "20%", fig.align="center", fig.border = "none", echo=FALSE}
knitr::include_graphics("vignettes/image_denom_total.PNG")
```
...
```{r, out.width = "20%", fig.align="center", fig.border = "none", echo=FALSE}
knitr::include_graphics("vignettes/image_denom_ext.PNG")
```
...
```{r, out.width = "20%", fig.align="center", fig.border = "none", echo=FALSE}
knitr::include_graphics("vignettes/image_denom_col.PNG")
```
...
knitr::include_graphics("vignettes/image.PNG")
```
